...
class CustomDataset(data.Dataset):
    def __init__(self, root, phase = 'train', repeat_num = 10, transform=None,):
        ...
        if self.phase != 'train':
            ...
            train_data = []
            # make_true_pair
            id_list = list(set(train_meta['face_id']))  # people id
            ...
            self.label_path = os.path.join(root, self.phase, f'{self.phase}_label_{repeat_num}.csv')
            print(f'{self.phase}_label_{repeat_num}.csv 저장 완료')
